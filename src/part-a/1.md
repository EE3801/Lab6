...
You should also update the DataProcessingTools repository by doing:

>[Headnode]
>```shell
>cd /data/src/DataProcessingTools
>git pull
>```


## 3.
If you would like to use a snapshot with completed data from Lab 5, you can delete your current cluster, make a copy of the following snapshot: `snap-0ad0e850931c25199`, edit the `cluster-config.yaml` file on your EC2 instance to use the Snapshot ID of your copy, and then create a new cluster. Once you have your new cluster ready, you will have to copy your AWS credentials and your key pair from your EC2 instance to the `/data` directory again, as well as clone your `PyHipp` repository to `/data/src/PyHipp` again.